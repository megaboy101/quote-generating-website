...
var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{content: 'Nothing has happened yet', error: _elm_lang$core$Maybe$Nothing},
	{ctor: '[]'});
...
var _user$project$Main$getJson = function () {
	var request = _elm_lang$http$Http$getString(_user$project$Main$apiUrl);
